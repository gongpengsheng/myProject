...
//        }
        String file = "C:\\Users\\Gentle丶龚\\Desktop\\项目3\\test\\a.csv";
        try {
...
//        	writer.write(licenseNo+","+vehicleFrameNo+","+engineNo+","+payFlowId+"\n");// 写内容 
        	...
        	writer.write(RandomValueUtil.getChineseName()+","+name_sex+","+RandomValueUtil.getTel()+","+RandomValueUtil.getEmail(6,9)+","+RandomValueUtil.getRoad()+"\n");// 写内容 
        	}
